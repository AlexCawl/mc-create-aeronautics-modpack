...
| Мод | Сторона | Источник | Файл |
| --- | --- | --- | --- |
| Artifacts | `both` | [Modrinth](https://modrinth.com/mod/artifacts) | `artifacts-neoforge-13.2.1.jar` |
...
| YUNG's Better Nether Fortresses | `server` | [Modrinth](https://modrinth.com/mod/yungs-better-nether-fortresses) | `YungsBetterNetherFortresses-1.21.1-NeoForge-3.1.5.jar` |
| YUNG's Better Ocean Monuments | `server` | [Modrinth](https://modrinth.com/mod/yungs-better-ocean-monuments) | `YungsBetterOceanMonuments-1.21.1-NeoForge-4.1.2.jar` |
| YUNG's Better Strongholds | `server` | [Modrinth](https://modrinth.com/mod/yungs-better-strongholds) | `YungsBetterStrongholds-1.21.1-NeoForge-5.1.3.jar` |
| YUNG's Better Witch Huts | `server` | [Modrinth](https://modrinth.com/mod/yungs-better-witch-huts) | `YungsBetterWitchHuts-1.21.1-NeoForge-4.1.1.jar` |
...
| YUNG's API | `both` | [Modrinth](https://modrinth.com/mod/yungs-api) | `YungsApi-1.21.1-NeoForge-5.1.6.jar` |
...
| NoDim | `server` | [Modrinth](https://modrinth.com/plugin/no-dim) | `NoDim-1.3.1.jar` |
